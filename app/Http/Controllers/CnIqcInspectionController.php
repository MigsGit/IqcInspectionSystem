...
use App\Models\CnIqcInspectionMod;
    ...
    public function saveCnIqcInspection(CnIqcInspectionRequest $request)
    {
        ...
        try {
            ...
            if(isset($request->modeOfDefects)){
                CnIqcInspectionMod::where('cn_iqc_inspection_id', $iqc_inspections_id)->update([
                    'deleted_at' => date('Y-m-d H:i:s')
                ]);
                foreach ( $mod_lot_no as $key => $value) {
                    CnIqcInspectionMod::insert([
                ...
                if(CnIqcInspectionMod::where('cn_iqc_inspection_id', $iqc_inspections_id)->exists()){
                    CnIqcInspectionMod::where('cn_iqc_inspection_id', $iqc_inspections_id)->update([
                        'deleted_at' => date('Y-m-d H:i:s')
                    ]);
                }
