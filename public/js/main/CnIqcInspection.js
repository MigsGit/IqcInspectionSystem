// $(document).ready(function () {
    ...
    const saveCnIqcInspection = function (categoryMaterialId)
    {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response['result'] === 1){
                    ...
                    dataTable.iqcCnWhsPackagingInspected.ajax.url("load_cn_iqc_inspection?category_material="+categoryMaterialId).draw();
                    Swal.fire({
                        position: "center",
                        icon: "success",
