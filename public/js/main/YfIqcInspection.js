// $(document).ready(function () {
    ...
    const getYfIqcInspectionById = function (iqcInpectionId,iqcCategoryMaterialId)
    {
        let data = {
            "iqc_inspection_id"        : iqcInpectionId,
        }
        call_ajax(data, 'get_yf_iqc_inspection_by_id', function(response){
            ...
            //whsReceiving  let iqcInspectionsMods = tblWhsTrasanction.cn_iqc_inspections_mods[0].iqc_dropdown_detail.dropdown_details;
            let iqcInspectionsMods = tblWhsTrasanction.yf_iqc_inspections_mods;
    ...
    const saveYfIqcInspection = function (categoryMaterialId)
    {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response['result'] === 1){
                    ...
                    dataTable.iqcYfWhsPackagingInspected.ajax.url("load_yf_iqc_inspection?category_material="+categoryMaterialId).draw();
                    Swal.fire({
                        position: "center",
                        icon: "success",
