...
Route::controller(CnIqcInspectionController::class)->group(function () {
    ...
    Route::get('/load_cn_fixed_whs_packaging', 'loadCnFixedWhsPackaging')->name('load_cn_fixed_whs_packaging');
    Route::get('/get_cn_whs_packaging_by_id', 'getCnWhsPackagingById')->name('get_cn_whs_packaging_by_id');
    Route::get('/get_cn_fixed_whs_packaging_by_id', 'getCnFixedWhsPackagingById')->name('get_cn_fixed_whs_packaging_by_id');
